...
/**
  ...
  */
class DiscretizeInBulk(fromOperation: Operation, val info: OperationInfo) extends Operation {

  val properties: Constants[Property] = {
    Constants(
      ArrayElement("predicates", "Predicates", SummaryTitle.NoTitle) { implicit context =>
        new FixedText[String]("predicate", "Predicate", validator = RegExp("<.*>|\\w+:.*", true))
      },
