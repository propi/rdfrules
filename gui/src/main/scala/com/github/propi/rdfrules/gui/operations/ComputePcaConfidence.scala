...
/**
  ...
  */
class ComputePcaConfidence(fromOperation: Operation, val info: OperationInfo) extends Operation {
  val properties: Constants[Property] = Constants(
    ...
    new OptionalText[Int]("topk", "Top-k", description = "Get top-k rules with highest PCA confidence. This is the optional parameter.", validator = GreaterThanOrEqualsTo[Int](1))
  )
