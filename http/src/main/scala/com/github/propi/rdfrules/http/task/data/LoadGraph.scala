...
/**
  ...
  */
class LoadGraph(graphName: Option[TripleItem.Uri], path: Option[String], url: Option[URL], format: Option[Option[RdfSource]])(implicit debugger: Debugger) extends Task.NoInputDatasetTask {
