...
/**
  ...
  */
class PredictTriples(path: String, format: Option[Option[RulesetSource]], predictionType: PredictionType, onlyFunctionalProperties: Boolean)(implicit debugger: Debugger) extends Task[Index, Dataset] {
