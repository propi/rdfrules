...
/**
  ...
  */
class CompleteDataset(path: String, format: Option[Option[RulesetSource]], onlyNewPredicates: Boolean, onlyFunctionalProperties: Boolean)(implicit debugger: Debugger) extends Task[Index, Dataset] {
