...
import com.github.propi.rdfrules.data.{Dataset, RdfReader}
...
/**
  ...
  */
class LoadDataset(path: Option[String], url: Option[URL])(implicit debugger: Debugger) extends Task.NoInputDatasetTask {
