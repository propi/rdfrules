...
import eu.easyminer.rdf.rule.{Atom, Measure}
...
trait RuleCounting extends AtomCounting {
  ...
  implicit class PimpedRule(rule: ClosedRule) {
    ...
    /**
      ...
      */
    def withConfidence(minConfidence: Double): ClosedRule = {
    ...
    /**
      ...
      */
    def withHeadConfidence: ClosedRule = {
    ...
    /**
      ...
      */
    def withPcaConfidence(minPcaConfidence: Double): ClosedRule = {
