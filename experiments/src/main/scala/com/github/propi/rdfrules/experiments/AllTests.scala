...
object AllTests {
  ...
  def main(args: Array[String]): Unit = {
    ...
    RdfRulesExperiments.main(s"-runlogical $input -times 1 -output experiments/data/result_logical.txt".split(' '))
    RdfRulesExperiments.main(s"-runconstants $input -times 1 -output experiments/data/result_constants.txt".split(' '))
    RdfRulesExperiments.main(s"-runcores $input -times 1 -output experiments/data/result_cores.txt".split(' '))
